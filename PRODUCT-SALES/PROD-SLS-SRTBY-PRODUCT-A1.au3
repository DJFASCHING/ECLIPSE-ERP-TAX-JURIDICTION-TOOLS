...
Func RWFile($sFilePath, $dFilePath)
	...
	Local $sMrk, $sA1, $sB1, $sC1, $sD1, $sE1, $sF1, $sG1, $sH1, $sI1, $sJ1, $sK1, $sL1, $sM1
	...
	For $i = 6 To UBound($aArray) - 1 ; Skip 7 header lines in read-array
		...
		$sMrk = StringMid ($aArray[$i],1 ,1) ; & mark at front of Customer ID
		;$sMrk = StringStripWS ($sMrk , 2) ;Remove trailing whitespace
		;$sMrk = StringStripWS ($sMrk, 1) ;Remove leading whitespace
		;$sMrk = StringReplace($sMrk, ",","")  ;Remove commas
